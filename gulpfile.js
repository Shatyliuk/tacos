...
gulp.task('js:dev', function () {
    return gulp.src(['node_modules/svg4everybody/dist/svg4everybody.min.js', 'node_modules/magnific-popup/dist/jquery.magnific-popup.min.js'])
...
gulp.task('js:copy', function () {
    return gulp.src(['./dev/static/js/*.js', '!./dev/static/js/libs.min.js', 'node_modules/magnific-popup/dist/jquery.magnific-popup.min.js'])
        .pipe(gulp.dest('./build/static/js/'))
        .pipe(browserSync.reload({
            stream: true
        }))
